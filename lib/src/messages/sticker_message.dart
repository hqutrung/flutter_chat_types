...
@JsonSerializable()
@immutable
abstract class StickerMessage extends Message {
  /// Creates an image message.
  const StickerMessage._({
    ...
    required this.uri,
    this.width,
  }) : super(type: type ?? MessageType.sticker);

  const factory StickerMessage({
  ...
  factory StickerMessage.fromPartial({
    required User author,
    int? createdAt,
    required String id,
...
class _StickerMessage extends StickerMessage {
